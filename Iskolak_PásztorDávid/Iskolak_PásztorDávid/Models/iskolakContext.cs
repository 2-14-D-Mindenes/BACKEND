...
{
    public partial class iskolakContext : DbContext
    {
        public iskolakContext()
        {
        }

        public iskolakContext(DbContextOptions<iskolakContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySQL("server=localhost;database=iskolak;user=root;password=;ssl mode=none;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Iskolalogok>(entity =>
            {
                ...
                entity.HasIndex(e => e.IskolaId, "iskola_id_2");
